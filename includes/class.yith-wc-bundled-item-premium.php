...
if ( !class_exists( 'YITH_WC_Bundled_Item' ) ) {
    ...
    class YITH_WC_Bundled_Item {
        ...
        public function __construct( $parent, $item_id ) {
            ...
            $this->filtered_variations = array_map( 'YITH_WCPB_WPML_Compatibility::get_wpml_product_id_current_language', $this->filtered_variations );
            ...
            if ( !$bundled_product->is_type( 'variable' ) ) {
                // SIMPLE
                $this->min_price = $bundled_product->get_regular_price();
        ...
        public function get_price_html( $price_html, $product ) {
            ...
            $price         = yit_get_display_price( $product, $price );
