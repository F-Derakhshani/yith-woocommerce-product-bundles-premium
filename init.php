...
if ( !defined( 'YITH_WCPB_VERSION' ) ) {
    define( 'YITH_WCPB_VERSION', '1.2.5' );
}
...
function yith_wcpb_pr_init() {
    ...
    require_once( 'includes/class.yith-wc-product-bundle-premium.php' );
    require_once( 'includes/class.yith-wc-bundled-item-premium.php' );
    ...
    require_once( 'class.yith-wcpb-admin-premium.php' );
    require_once( 'class.yith-wcpb-frontend-premium.php' );
    require_once( 'class.yith-wcpb-premium.php' );
